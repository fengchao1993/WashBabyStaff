...
/**
 * Created by Lizhangfeng on 2015/12/16 0016.
 * Description:
 */
public abstract class BaseSectionIndexerAdapter<T, VH> extends BaseAdapter implements SectionIndexer{
    ...
    public BaseSectionIndexerAdapter(Context context) {
        this.context = context;
    }

    public BaseSectionIndexerAdapter(List<T> tList, Context context) {
        this.tList = tList;
        this.context = context;
    }
